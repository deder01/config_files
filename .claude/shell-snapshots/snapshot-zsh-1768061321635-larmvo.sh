...
zle-keymap-select () {
	...
	if [[ "${VI_MODE_RESET_PROMPT_ON_MODE_CHANGE:-}" = true ]]
	then
		zle reset-prompt
		zle -R
	fi
...
zsh_stats () {
	fc -l 1 | awk '{ CMD[$2]++; count++; } END { for (a in CMD) print CMD[a] " " CMD[a]*100/count "% " a }' | grep --color=auto --exclude-dir={.bzr,CVS,.git,.hg,.svn,.idea,.tox} -v "./" | sort -nr | head -20 | column -c3 -s " " -t | nl
}
# Shell Options
setopt alwaystoend
setopt autocd
...
alias -- gocms='cd /home/deder/workspaces/cms_react_app/src'
alias -- gorepos='cd repos'
alias -- goworkspaces='cd /home/deder/workspaces'
alias -- gp='git push'
...
alias -- grecover='gitk --all $( git fsck --no-reflog | awk '\''/dangling commit/ {print }'\'' )'
...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/home/deder/.local/share/claude/versions/2.1.2 --ripgrep'
fi
export PATH=/home/deder/.pyenv/shims\:/home/deder/.pyenv/bin\:/home/deder/.nvm/versions/node/v18.20.5/bin\:/home/deder/.yarn/bin\:/home/deder/.config/yarn/global/node_modules/.bin\:/usr/local/opt/ruby/bin\:/usr/local/lib/ruby/gems/3.0.0/bin/\:/home/deder/.local/bin\:/home/deder/bin\:/home/deder/usr/bin\:/usr/kerberos/bin\:/usr/local/bin\:/usr/bin\:/bin\:/usr/sbin\:/usr/lib/wsl/lib\:/sbin\:/usr/local/sbin\:/usr/local/bin\:/home/deder/node_modules/.bin\:/home/deder/.local/bin:\:/home/deder/.local/python-3.6.3/bin\:/home/deder/.toolbox/bin:\:/home/deder/.fzf/bin\:/mnt/c/Users/david/AppData/Local/Programs/cursor/resources/app/bin
